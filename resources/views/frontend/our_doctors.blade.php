            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="med_tittle_cont_wrapper">
                    <div class="med_tittle_cont">
                        <h1>{{ __('messages.Teamwork') }}</h1>
                        <ol class="breadcrumb">
                            <li><a href="{{route('index')}}">{{ __('messages.home') }}</a>
                            </li>
                            <li>{{ __('messages.Teamwork') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            {{-- <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <ul class="protfoli_filter ">
                    ...
                    <li data-filter=".business"><a href="#">الأول</a></li>
                    <li data-filter=".website"><a href="#">الثانى</a></li>
                    <li class="d-none d-sm-none d-md-none d-lg-block" data-filter=".surgery"><a href="#">الثالث</a></li>
                    <li data-filter=".photoshop"><a href="#">الرابع</a></li>
                    <li data-filter=".heart"><a href="#">الخامس</a></li>
                    <li class="d-none d-sm-none d-md-none d-lg-block" data-filter=".logo"><a href="#">السادس</a></li>
                    <li data-filter=".hair"><a href="#">السابع</a></li>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12  portfolio-wrapper hair all business website photoshop">
                        <div class="team_about our_doc_main dc_porftfolio_img">
                            ...
                            <div class="team_img special_team_img_mn">
                                <img src="{{asset('uploads/doctors/'.$doctor->img)}}" alt="img" class="img-responsive">
                            </div>
                            <div class="team_txt">
                                <h1><a href="#">{{$doctor->name}}</a></h1>
                                <p>({{$doctor->specialist}})</p>
                            </div>
                            <div class="team_icon_hover">
                                <ul>
                                    <li><a href="{{$doctor->facebook_link}}"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    </li>
                                    <li><a href="{{$doctor->twitter_link}}"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                    </li>
                                    <li><a href="{{$doctor->linkedin_link}}"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                                    </li>
                                    <li><a href="{{$doctor->youtube_link}}"><i class="fa fa-youtube-play" aria-hidden="true"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
