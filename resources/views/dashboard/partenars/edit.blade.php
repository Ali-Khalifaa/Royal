...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{route('dashboard.partenar.index')}}">اعدادات سكشن الشركاء</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>تعديل</span>
    ...
    <h1 class="page-title">تعديل شريك</h1>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form" style="height: auto;">
                    <form method="POST" action="{{route('dashboard.partenar.update',$partenar->id)}}"  role="form" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('put')}}
                            ...
                            <div class="form-group form-md-line-input has-success">
                                ...
                                <div class="input-group" >
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="file" name="img" id="img" value="{{ $partenar->img }} required" class="form-control" >
                                    </div>
                                    <img class="image" src="{{asset('uploads/event/'.$partenar->img)}}"  alt="Image" style="width:100px;height:100px;margin-left:320px;">  
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-2 col-md-10">
                                        <a href="{{route('dashboard.partenar.index')}}" class="btn default">الغاء</a>
