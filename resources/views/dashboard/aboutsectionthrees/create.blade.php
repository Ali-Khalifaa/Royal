...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{route('dashboard.aboutsectionthree.index')}}">صفحة تفاصيل السكشن الثالث</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>اضافة</span>
    ...
    <h1 class="page-title">أضافة السكشن الثالث</h1>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form" style="height: auto;">
                    <form method="POST" action="{{route('dashboard.aboutsectionthree.store')}}"  role="form" class="form-horizontal">
                        {{ csrf_field() }}
                        {{ method_field('post')}}
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group form-md-line-input has-success">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea required name="{{ $locale }}[title]" id="title" value="{{ old($locale . '.title') }}" class="form-control col-md-7 col-xs-12" ></textarea>
                                </div>
                            </div>
                            @endforeach
