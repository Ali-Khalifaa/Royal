...
@section('content')
    ...
    <h1 class="page-title"> أضافة عداد</h1>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form" style="height: auto;">
                    <form method="POST" action="{{route('dashboard.counter.store')}}"  role="form" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('post')}}
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group form-md-line-input has-success">
                                <label class="col-md-2 control-label" for="form_control_1">الرقم</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="number" id="numper" name="numper" value="{{ old('numper') }}" required class="form-control col-md-6 col-xs-12">
                                </div>
                            </div>
