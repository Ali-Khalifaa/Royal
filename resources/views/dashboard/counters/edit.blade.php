...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{route('dashboard.counter.index')}}">اعدادات سكشن العداد</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>تعديل</span>
    ...
    <h1 class="page-title">تعديل العداد</h1>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form" style="height: auto;">
                    <form method="POST" action="{{route('dashboard.counter.update',$counter->id)}}"  role="form" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('put')}}
                        ...
                        <div class="form-body">
                            @foreach (config('translatable.locales') as $locale)
                                <div class="form-group form-md-line-input has-success">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="title" name="{{ $locale }}[title]" value="{{$counter->translate($locale)->title}}" required class="form-control col-md-6 col-xs-12">
                                    </div>
                                </div>
                            @endforeach
                            ...
                            <div class="form-group form-md-line-input has-success">
                                <label class="col-md-2 control-label" for="form_control_1">{{ $locale }}.الرقم</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="number" id="numper" name="numper" value="{{$counter->numper}}" required class="form-control col-md-6 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-2 col-md-10">
                                        <a href="{{route('dashboard.counter.index')}}" class="btn default">الغاء</a>
