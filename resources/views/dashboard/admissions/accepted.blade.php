...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span> الطلاب المقبولين فى المعهد </span>
            </li>
        </ul>

    </div>
    <h1 class="page-title"> الطلاب المقبولين فى المعهد </h1>
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">جدول عرض تفاصيل الطلاب المقبولين فى المعهد</span>
                    </div>
                    <div class="tools"> </div>
                </div>
