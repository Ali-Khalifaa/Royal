            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    <table class="table table-hover table-striped table-bordered">
                        ...
                        <form method="POST" action="{{route('dashboard.addmission.changeStepOne',$admission->id)}}"  role="form" class="form-horizontal">
                            {{ csrf_field() }}
                            {{ method_field('put')}}
                            <tr>
                                <td>تغيير موعد المقابلة الشخصية الأولى </td>
                                <td>
                                    <input type="datetime-local" name="interview_one" required>
                                </td>
                            </tr>
                            <tr>
                                <td> تغير مكان المقابة الشخصية الأولى</td>
                                <td>
                                    <input type="text" name="plase_interview_one" required>
                                </td>
                            </tr>
                            <tr>
                                <td>
