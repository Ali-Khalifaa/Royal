...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span> الطلاب الراسبون </span>
            </li>
        </ul>

    </div>
    <h1 class="page-title"> الطلاب الراسبون </h1>
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">جدول عرض تفاصيل الطلاب الراسبون فى الأمتحان</span>
                    </div>
                    <div class="tools"> </div>
                </div>
                        ...
                        <tbody>
                            ...
                            @foreach($admissions as $index=>$admission)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="label label-sm label-warning"> {{$admission->result }} </span></td>
