            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green-sharp sbold">عرض تفاصيل المتقدم </span>
                    </div>
                </div>
                <div class="portlet-body">
                    <table class="table table-hover table-striped table-bordered">
                        ...
                        @if($admission->users->interview_one != null)
                            <tr>
                                <td> موعد المقابلة الشخصية الأولى </td>
                                <td>
                        ...
                        @if($admission->users->plase_interview_one != null)
                            <tr>
                        ...
                        @if($admission->users->interview_two != null)
                            <tr>
                        ...
                        @if($admission->users->plase_interview_two != null)
                            <tr>
                        ...
                        @if($admission->users->date_exam != null)
                            <tr>
                                <td> موعد اللأمتحان</td>
                                <td>
                                    <h5> {{ $admission->users->date_exam }} </h5>
                                </td>
                            </tr>
                        @endif
                        ...
                        <tr>
                            <td> حالة الأمتحان</td>
                            @if($admission->users->certificate->result == 'successful')
                                <td>
                                    <span class="label label-sm label-success"> ناجح </span>
                                </td>
                            @else
                                <td >
                                    <span class="label label-sm label-warning"> راسب </span>
                                </td>
                            @endif
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <h5>( {{ $admission->users->certificate->number_of_questions }} / {{ $admission->users->certificate->correct_questions }} )</h5>
                            </td>
                        </tr>
                        ...
                        @if($admission->users->certificate != null)
                        <tr>
                            <td> نسبة النجاح فى الأمتحان</td>

                            <td>
                                <h5>{{ $admission->users->certificate->percentage }} %</h5>
                            </td>
                        </tr>
