                ...
                <div class="portlet-body">
                    <table class="table table-hover table-striped table-bordered">
                        ...
                        <tr>
                            <td> الجنسية </td>
                            <td>
                                <h5> {{$admission->nationalities->title }} </h5>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td> التخصص </td>
                            <td>
                                <h5> {{$admission->specializations->title }} </h5>
                            </td>
                        </tr>
                        <tr>
                            <td> حالة العمل </td>
                        ...
                        <form method="POST" action="{{route('dashboard.addmission.ExamDate',$admission->id)}}"  role="form" class="form-horizontal">
                            {{ csrf_field() }}
                            {{ method_field('put')}}
                            <tr>
                                <td> موعد الأمتحان </td>
