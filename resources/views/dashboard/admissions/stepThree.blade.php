...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>تحديد موعد الأمتحان </span>
            </li>
        </ul>

    </div>
    <h1 class="page-title">تحديد موعد الأمتحان </h1>
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">جدول عرض تفاصيل تحديد موعد الأمتحان  </span>
                    </div>
                    <div class="tools"> </div>
                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                        <thead>
                            <tr>
                                ...
                                <th><i class="fa fa-bookmark"></i> تحديد موعد الأمتحان </th>
                                <th><i class="fa fa-bookmark"></i> رفض </th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            @foreach($admissions as $index=>$admission)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('dashboard.addmission.toexam', $admission->id)}}" class="btn btn-transparent dark btn-outline btn-circle btn-sm">
                                            تحديد موعد الأمتحان
                                        </a>
