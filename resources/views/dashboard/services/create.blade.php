...
@section('content')
    ...
    <h1 class="page-title">أضافة خدمات بالصفحة الرئيسية</h1>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form" style="height: auto;">
                    <form method="POST" action="{{route('dashboard.service.store')}}"  role="form" class="form-horizontal">
                        {{ csrf_field() }}
                        {{ method_field('post')}}
                        ...
                        <div class="form-body">
                            @foreach (config('translatable.locales') as $locale)
                                <div class="form-group form-md-line-input has-success">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="address" name="{{ $locale }}[title]" value="{{ old($locale . '.title') }}" required class="form-control col-md-6 col-xs-12">
                                    </div>
                                </div>
                            @endforeach
                            ...
                            @foreach (config('translatable.locales') as $locale)
                                <div class="form-group form-md-line-input has-success">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea required name="{{ $locale }}[desc]" id="title" value="{{ old($locale . '.desc') }}" class="form-control col-md-7 col-xs-12" ></textarea>
                                    </div>
                                </div>
                            @endforeach
