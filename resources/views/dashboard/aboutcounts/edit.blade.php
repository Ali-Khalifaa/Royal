...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{route('dashboard.aboutcount.index')}}">سكشن العداد</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>تعديل</span>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form" style="height: auto;">
                    <form method="POST" action="{{route('dashboard.aboutcount.update',$aboutcount->id)}}"  role="form" class="form-horizontal">
                        {{ csrf_field() }}
                        {{ method_field('put')}}
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group form-md-line-input has-success">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="name" name="{{ $locale }}[name]" value="{{$aboutcount->translate($locale)->name}}" required class="form-control col-md-6 col-xs-12">
                                </div>
                            </div>
                            @endforeach

                            <div class="form-group form-md-line-input has-success">
                                <label class="col-md-2 control-label" for="form_control_1">العداد</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="count" name="count"  value="{{ $aboutcount->count}}" required class="form-control col-md-6 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-2 col-md-10">
                                        <a href="{{route('dashboard.aboutcount.index')}}" class="btn default">الغاء</a>
