...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{route('dashboard.chose.index')}}">صفحة تفاصيل لماذا تختارنا</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>تعديل</span>
    ...
    <h1 class="page-title">تعديل سكشن لماذا تختارنا</h1>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form" style="height: auto;">
                    <form method="POST" action="{{route('dashboard.chose.update',$chose->id)}}" role="form"
                        ...
                        <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input has-success">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea required name="{{ $locale }}[title]" id="title"
                                                  value="{{$chose->translate($locale)->title}}"
                                                  class="form-control col-md-7 col-xs-12">{{$chose->translate($locale)->title}}</textarea>
                                    </div>
                                </div>
                            @endforeach
                            ...
                            <div class="form-group form-md-line-input has-success">
                                ...
                                <div class="input-group">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="file" name="pdf" id="img" class="form-control" value="{{$chose->pdf}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-2 col-md-10">
                                        <a href="{{route('dashboard.chose.index')}}" class="btn default">الغاء</a>
