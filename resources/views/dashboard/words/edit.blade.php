...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{route('dashboard.word.index')}}">كلمة مجلس الادارة</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>تعديل</span>
    ...
    <h1 class="page-title">أضافة كلمة مجلس الادارة بالصفحة الرئيسية</h1>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form" style="height: auto;">
                    <form method="POST" action="{{route('dashboard.word.update',$word->id)}}"  role="form" class="form-horizontal">
                        {{ csrf_field() }}
                        {{ method_field('put')}}
                        ...
                        <div class="form-body">
                            ...
                            @foreach (config('translatable.locales') as $locale)
                                <div class="form-group form-md-line-input has-success">
                                    <label class="col-md-2 control-label" for="form_control_1">{{ $locale }}.تفاصيل من نحن</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea required name="{{ $locale }}[desc]" id="title" value="{{$word->translate($locale)->desc}}" class="form-control col-md-7 col-xs-12" >{{$word->translate($locale)->desc}}</textarea>
                                    </div>
                                </div>
                            @endforeach
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-2 col-md-10">
                                        <a href="{{route('dashboard.word.index')}}" class="btn default">الغاء</a>
