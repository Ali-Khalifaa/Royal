...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{route('dashboard.media.index')}}"> المركز الاعلامي</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>تعديل</span>
    ...
    <h1 class="page-title">تعديل  المركز الاعلامي</h1>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form" style="height: auto;">
                    ...
                    <form method="POST" action="{{ url('/dashboard/media/update/'.$media->id) }}" enctype="multipart/form-data"  role="form" class="form-horizontal">
                        {{ csrf_field() }}
                        {{ method_field('put')}}
                        ...
                        <div class="form-body">
                            @foreach (config('translatable.locales') as $locale)
                                <div class="form-group form-md-line-input has-success">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="name" name="{{ $locale }}[title]" value="{{$media->translate($locale)->title}}" required class="form-control col-md-6 col-xs-12">
                                    </div>
                                </div>
                            @endforeach
                            ...
                            <div class="form-group form-md-line-input has-success">
                                ...
                                <div class="input-group" >
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input required type="file" name="img" id="img" value="{{ $media->img }}" class="form-control" >
                                    </div>
                                    <img class="image" src="{{asset('uploads/media/'.$media->img)}}"  alt="Image" style="width:100px;height:100px;margin-left:320px;">  
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-2 col-md-10">
                                        <a href="{{route('dashboard.media.index')}}" class="btn default">الغاء</a>
