...
@section('content')
    ...
    <h1 class="page-title">أضافة موظف</h1>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form" style="height: auto;">
                    <form method="POST" action="{{route('dashboard.agent.store')}}"  role="form" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('post')}}
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group form-md-line-input has-success">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="position" name="{{ $locale }}[position]" value="{{ old($locale . '.position') }}" required class="form-control col-md-6 col-xs-12">
                                </div>
                            </div>
                            @endforeach
