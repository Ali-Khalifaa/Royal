...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{route('dashboard.aboutsectionone.index')}}">اعدادات السكشن الأول </a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>اضافة</span>
    ...
    <h1 class="page-title"> أضافة السكشن الأول</h1>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form" style="height: auto;">
                    <form method="POST" action="{{route('dashboard.aboutsectionone.store')}}"  role="form" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('post')}}
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group form-md-line-input has-success">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="mission" name="{{ $locale }}[mission]" value="{{ old($locale . '.mission') }}" required class="form-control col-md-6 col-xs-12">
                                </div>
                            </div>
                            @endforeach
                            ...
                            <div class="form-group form-md-line-input has-success">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea required name="{{ $locale }}[desc_mission]" id="desc_mission" value="{{ old($locale . '.desc_mission') }}" class="form-control col-md-7 col-xs-12" ></textarea>
                                </div>
                            </div>
                            @endforeach
