...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{route('dashboard.footer.index')}}">صفحة تفاصيل صور الانستجرام</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>اضافة</span>
    ...
    <h1 class="page-title">أضافة صور الانستجرام</h1>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form" style="height: auto;">
                    <form method="POST" action="{{route('dashboard.footer.store')}}" role="form"
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group form-md-line-input has-success">
                                ...
                                <div class="input-group">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" name="link" id="img" required class="form-control">
                                    </div>
                                </div>
                            </div>
