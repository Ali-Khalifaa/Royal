...
@section('content')
    ...
    <h1 class="page-title">أضافة سكشن الفيديو</h1>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form" style="height: auto;">
                    <form method="POST" action="{{route('dashboard.video.store')}}"  role="form" class="form-horizontal">
                        {{ csrf_field() }}
                        {{ method_field('post')}}
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group form-md-line-input has-success">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="link" name="link" value="{{ old('link') }}" required class="form-control col-md-6 col-xs-12">
                                </div>
                            </div>
