...
@section('content')
    ...
    {{-- <a href="{{route('dashboard.video.create')}}" class="btn green"> أضافة
                    ...
                    <div class="table-scrollable">
                        <table class="table table-striped table-bordered table-advance table-hover">
                            ...
                            <tr>
                                ...
                                <th><i class="fa fa-bookmark-o"></i> لينك الفيديو </th>
                            ...
                            @foreach($videos as $index=>$video)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('dashboard.video.edit', $video->id)}}" class="btn btn-outline btn-circle btn-sm purple">
                                            <i class="fa fa-edit"></i> تعديل </a>
                                        {{-- <form method="POST" onclick="return confirm('Are you sure?')" action="{{route('dashboard.video.destroy', $video->id)}}"  style="display:inline" >
                                            {{ csrf_field() }}
                                            {{ method_field('delete') }}
