...
@section('content')
    ...
    <h1 class="page-title">أضافة عنوان فرعى الى سكشن من نحن</h1>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form" style="height: auto;">
                    <form method="POST" action="{{route('dashboard.aboutsec.store')}}"  role="form" class="form-horizontal">
                        {{ csrf_field() }}
                        {{ method_field('post')}}
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group form-md-line-input has-success">
                                <label class="col-md-2 control-label" for="form_control_1">{{ $locale }}.عنوان فرعى</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="name" name="{{ $locale }}[title]" value="{{ old($locale . '.title') }}" required class="form-control col-md-6 col-xs-12">
                                </div>
                            </div>
                            @endforeach
