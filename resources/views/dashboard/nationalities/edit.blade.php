...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{route('dashboard.nationality.index')}}">جنسيات الطلاب</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>تعديل</span>
    ...
    <h1 class="page-title">تعديل الجنسية</h1>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form" style="height: auto;">
                    <form method="POST" action="{{route('dashboard.nationality.update',$nationality->id)}}"  role="form" class="form-horizontal">
                        {{ csrf_field() }}
                        {{ method_field('put')}}
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group form-md-line-input has-success">
                                <label class="col-md-2 control-label" for="form_control_1">{{ $locale }}.الجنسية </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="title" name="{{ $locale }}[title]" value="{{$nationality->translate($locale)->title}}" required class="form-control col-md-6 col-xs-12">
                                </div>
                            </div>
                            @endforeach
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-2 col-md-10">
                                        <a href="{{route('dashboard.nationality.index')}}" class="btn default">الغاء</a>
