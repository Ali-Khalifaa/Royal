...
@section('content')
    ...
    <h1 class="page-title">تعديل سكشن السلايدر</h1>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form" style="height: auto;">
                    <form method="POST" action="{{route('dashboard.slider.update',$slider->id)}}" role="form"
                        ...
                        <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input has-success">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea required name="{{ $locale }}[title]" id="title"
                                                  value="{{$slider->translate($locale)->title}}"
                                                  class="form-control col-md-7 col-xs-12">{{$slider->translate($locale)->title}}</textarea>
                                    </div>
                                </div>
                            @endforeach
                                ...
                                <div class="form-group form-md-line-input has-success">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea required name="{{ $locale }}[desc]" id="desc"
                                                  value="{{$slider->translate($locale)->desc}}"
                                                  class="form-control col-md-7 col-xs-12">{{$slider->translate($locale)->desc}}</textarea>
                                    </div>
                                </div>
                            @endforeach
                            ...
                            <div class="form-group form-md-line-input has-success">
                                ...
                                <div class="input-group">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="file" name="img" id="img" value="{{ $slider->img }} required"
                                               class="form-control">
                                    </div>
                                    <img class="image" src="{{asset('uploads/home/slider/'.$slider->img)}}"
