...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{route('dashboard.doctor.index')}}">اعدادات سكشن متخصصينا</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>تعديل</span>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form" style="height: auto;">
                    <form method="POST" action="{{route('dashboard.doctor.update',$doctor->id)}}"  role="form" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('put')}}
                        ...
                        <div class="form-body">
                            @foreach (config('translatable.locales') as $locale)
                                <div class="form-group form-md-line-input has-success">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="name" name="{{ $locale }}[name]" value="{{$doctor->translate($locale)->name}}" required class="form-control col-md-6 col-xs-12">
                                    </div>
                                </div>
                            @endforeach
                            ...
                            @foreach (config('translatable.locales') as $locale)
                                <div class="form-group form-md-line-input has-success">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="specialist" name="{{ $locale }}[specialist]" value="{{$doctor->translate($locale)->specialist}}" required class="form-control col-md-6 col-xs-12">
                                    </div>
                                </div>
                            @endforeach
                            ...
                            <div class="form-group form-md-line-input has-success">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="facebook_link" name="facebook_link" value="{{ $doctor->facebook_link }}" required class="form-control col-md-6 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-group form-md-line-input has-success">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="twitter_link" name="twitter_link" value="{{ $doctor->twitter_link }}" required class="form-control col-md-6 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-group form-md-line-input has-success">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="linkedin_link" name="linkedin_link" value="{{ $doctor->linkedin_link }}" required class="form-control col-md-6 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-group form-md-line-input has-success">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="youtube_link" name="youtube_link" value="{{ $doctor->youtube_link}}" required class="form-control col-md-6 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-group form-md-line-input has-success">
                                ...
                                <div class="input-group" >
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="file" name="img" id="img" value="{{ $doctor->img }} required" class="form-control" >
                                    </div>
                                    <img class="image" src="{{asset('uploads/doctors/'.$doctor->img)}}"  alt="Image" style="width:100px;height:100px;margin-left:320px;">  
